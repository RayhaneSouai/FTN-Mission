...
public interface IRecordService {
    List<RecordDTO> getPersonalRecords(Long swimmerId);
    List<RecordDTO> getAllNationalRecords();
    RecordDTO getNationalRecordForEvent(Integer distance, StrokeType stroke, Gender gender); }
