...
public interface PerformanceRepository extends JpaRepository<Performance, Long> {
      ...
      List<Performance> findBySwimmerIdAndDistanceAndStrokeOrderByDateDesc(Long swimmerId, Integer distance,
                  StrokeType stroke);
      ...
      Optional<Performance> findNationalRecord(@Param("distance") Integer distance, @Param("stroke") StrokeType stroke,
      ...
      List<Performance> findNationalRanking(@Param("distance") Integer distance, @Param("stroke") StrokeType stroke,
                  @Param("gender") Gender gender, @Param("niveau") Niveau niveau, Pageable pageable);
      ...
      /**
       * Find the best (minimum) time for a swimmer in a specific event (distance +
       * stroke)
       */
      ...
      Optional<Double> findBestTimeBySwimmerAndEvent(@Param("swimmerId") Long swimmerId,
                  @Param("distance") Integer distance, @Param("stroke") StrokeType stroke);
}
